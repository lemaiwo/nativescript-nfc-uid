...
export class NativescriptNfcUid extends NativescriptNfcUidCommon implements NfcApi, NfcSessionInvalidator {
    public getName() {
        return "HelloWorld";
    }
    ...
    public available(): Promise<boolean> {
      return new Promise((resolve, reject) => {
        resolve(NativescriptNfcUid._available());
      });
    }
    ...
    public setOnTagDiscoveredListener(
      ...
      return new Promise((resolve, reject) => {
        resolve("on tag disovered listner added");
      });
    }
    ...
    public setOnNdefDiscoveredListener(
      ...
      return new Promise((resolve, reject) => {
        if (!NativescriptNfcUid._available()) {
          reject();
          return;
        }
